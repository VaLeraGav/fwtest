...
class Pagination
{
    ...
    {
        return ceil($this->total / $this->perpage) ?: 1; // ceil округляет в большую
    }

    public function getCurrentPage($page)
    {
        if (!$page || $page < 1) $page = 1; // проверка
    ...
    public function getParams()
    {
        ...
        $url = explode('?', $url); // site/category/phones/?page=2&lang=en 
        $uri = $url[0] . '?'; // запишется все то что после ?
